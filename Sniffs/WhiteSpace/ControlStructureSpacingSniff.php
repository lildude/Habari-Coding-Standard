<?php
/**
 * HabariCodingStandard_Sniffs_WhiteSpace_ControlStructureSpacingSniff.
 *
 * Modified copy of Squiz_Sniffs_WhiteSpace_ControlStructureSpacingSniff.
 *
 */
class HabariCodingStandard_Sniffs_WhiteSpace_ControlStructureSpacingSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (isset($tokens[$stackPtr]['parenthesis_opener']) === true) {
            ...
            if ($tokens[($parenOpener + 1)]['code'] !== T_WHITESPACE) {
				...
				$gap = 0;
                $error = 'Expected 1 spaces after opening bracket; %s found';
                $data  = array($gap);
