<?php
/**
 * Modified copy of PEAR_Sniffs_Functions_FunctionCallSignatureSniff.
 *
 * Added T_ISSET, ..... and other variable functions not picked up
 *
 */
class HabariCodingStandard_Sniffs_Functions_FunctionCallSignatureSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function processSingleLineCall(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $openBracket, $tokens)
    {
        ...
        if ($tokens[($openBracket + 1)]['code'] !== T_WHITESPACE && ($between !== $closer)) {
            // Checking this: $value = my_function([*]...).
            $error = 'Expecting 1 space after opening parenthesis of function call';
        ...
        if ($tokens[($closer - 1)]['code'] !== T_WHITESPACE) {
            ...
            // $value = my_function( ).
            if ($between !== $closer) {
                $error = 'Expecting 1 space before closing parenthesis of function call';
