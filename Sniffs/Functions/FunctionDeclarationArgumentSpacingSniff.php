<?php
/**
 * Modified copy of Squiz_Sniffs_Functions_FunctionDeclarationArgumentSpacingSniff.
 *
 */
class HabariCodingStandard_Sniffs_Functions_FunctionDeclarationArgumentSpacingSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
            ...
            if (empty($params) === false) {
                ...
                if ($whitespace['code'] !== T_WHITESPACE) {
                    ...
                    if ($nextToken !== $nextParam) {
                        ...
                        $error = 'Expected 1 space between opening bracket and argument "%s"; %s found';
                        $data  = array(
                                      $arg,
                                      //$gap,
									  0,
        ...
        if (empty($params) === true) {
            ...
            $error     = 'Expected 1 space between argument "%s" and closing bracket; %s found';
            $data      = array(
